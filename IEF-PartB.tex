...
\Dz and \Jpsi mesons will also be measured in \pbpb collisions (2018 data). In the case of these charmed mesons, the contributions of prompt and non-prompt production will be distinguished, for the first time
...
and the recent move of GM to Cagliari. The arrival of the 
applicant will extend the activities in the lab and its visibility in
...
will be the perfect fit where to nicely integrate the applicant, from the
...
If awarded the grant, the applicant will concentrate on the development of 
...
of the applicant who has pioneered the heavy-ion physics 
in CMS when only a few scientists started working 
in this area. 
The expertise the applicant has developed in the CMS 
heavy ion community could be crucial for 
concretise the huge potential of LHCb in this 
type of physics. 


The applicant, with long-lasting experience in heavy nuclei
...
researchers in the group will be a very important addition to the applicant's
...
group will give the applicant a better chance to pass on his previously
...
applicant will be inserted in a international network of 
research groups around the world.  The
Supervisor and the applicant will draw together a career development plan,
...
meetings will be held between the Supervisor and the applicant to monitor the
...
international training schools, the applicant will also have the chance to take
...
In the first year of the project the applicant could perform studies of \PgU production with the proton-lead sample which will be collected at the end of 2016. In this respect the applicant could profit from collaborating with the supervisor who has large expertise with the \PgU analysis at LHCb. Since event occupancies are expected to be lower in \pPb than in \PbPb, this sample will be the ideal complement to the existing \PbPb sample collected in 2015, as it has fewer challenges and larger statistics. The applicant could work with a PhD student on this analysis, thus refining his tutoring skills which can be pivotal in reaching the maturity for a teaching position.
...
Once tested on \pPb data, the applicant will be able to 
...
tracking strategy developed by the applicant, 
...
the applicant in this field would be enormous
...
group progress label font=\bfseries\small
  ...
  \ganttbar{INFN Cagliari workshop}{7}{7} 
  \ganttbar{}{19}{19} \\
  \ganttbar{Conference}{15}{15} 
  \ganttbar{}{20}{20} \\
  \ganttbar{Seminars}{11}{12}
  \ganttbar{}{23}{24}
...
CERN and to conferences, at the applicant’s own choice, validated by the supervisor. There will also be a close collaboration with LAL, where the supervisor started her ERC Consolidator Grant, also needing travel to France. As done in the past,
...
The applicant will be part of the INFN vibrant community and 
