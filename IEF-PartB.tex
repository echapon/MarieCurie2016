...
%  \underline{Beneficiary} & & & & & & \\\hline
  Istituto Nazionale di Fisica Nucleare & INFN & X & & Italy & Dipartimento di Fisica dell'Università di Cagliari,\qquad INFN Calgiari & Giulia Manca \\\hline
...
\caption{Gantt chart. The \pbpb run is expected in November 2018, its exact situation in the Gantt chart depends on the starting date of the project. The last line (\emph{W, C, S}) stands for \emph{Workshops, conferences, seminars}.\label{fig:gantt}}
\end{figure}
