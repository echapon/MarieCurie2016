...
%   Dipartimento di Fisica dell'Università di Cagliari /\qquad 
...
% (at central rapidity, in the electron channel) 
and LHCb. 
% (at forward rapidity, in the muon channel).
% However, LHCb only has access to the most peripheral \pbpb collisions at the moment, a situation this proposal aims at improving. 
% In addition, a lot of interest has been
% raised recently regarding the low-\pt excess of \Jpsi production in very peripheral \pbpb in ALICE~\footnote{ALICE Collaboration, PRL 116, 222301.}, thought to be coming from photoproduction. The 
...
% The corresponding rich physics program, beyond the scope of this project, does not suffer from the tracking limitations exposed above, thanks to the smaller track multiplicity at these much smaller centre-of-mass energies.
...
% This is a major stake in the LHCb \pbpb program: 
...
LHCb will collect \pPb data in November 2016, at $\sqrtsnn = 8\,\TeV$. The measurement of the nuclear modification factor of \PgU mesons, $\rpa (\PgUabc)$, is one of the most important analyses to be performed in this dataset. LHCb benefits from its excellent dimuon mass resolution ($\lesssim 0.5\%$ for $\pt < 100\,\GeVc$), % 11.55MeV for the J/psi according to p84 of https://cds.cern.ch/record/2202169/files/CERN-THESIS-2012-428_2.pdf
...
% The experience of the \ER with \Jpsi measurements in \pbpb in CMS will be of key importance. 
...
% Regular meetings and travel will be organised between the two institutions.
...
Cagliari.
% and supervised undergraduate students from the 
...
%and will in in particular coordinate the collaboration with the theory group in Cagliari, as he has done successfully in the past.
...
% feature of LHCb in heavy nuclei collisions. At the
...
%   \gantttitlelist{1,2}{1} \\
  \ganttbar[bar/.append style={fill=black}]{\pbpb run}{21}{22} \\
  \ganttbar[bar/.append style={fill=red}]{WP1}{1}{18} \\
  \ganttmilestone[inline, milestone/.append style={fill=red, rounded corners=3pt}]{M.1.1}{3} 
  \ganttmilestone[milestone/.append style={fill=red}]{M.1.1, D.1.X}{10} 
  ...
  \ganttmilestone[inline, milestone/.append style={fill=blue, rounded corners=3pt}]{M.2.1}{4} 
  \ganttmilestone[milestone/.append style={fill=blue}]{M.2.1, D.2.X}{12} 
...
%   \ganttmilestone[milestone/.append style={fill=green!50!black}]{}{20}
  ...
  \ganttmilestone[milestone/.append style={fill=cyan!50}]{Outreach}{2} % open days in April?
  \ganttmilestone[milestone/.append style={fill=cyan!50}]{}{14} % open days in April?
  \ganttmilestone[milestone/.append style={fill=cyan!50}]{}{7} % research night in September?
  \ganttmilestone[milestone/.append style={fill=cyan!50}]{}{19}\\ % research night in September?
  \ganttmilestone[milestone/.append style={fill=orange!50}]{W, C, S}{7} % Cagliari mini-workshop
  \ganttmilestone[milestone/.append style={fill=orange!50}]{}{19} % Cagliari mini-workshop
  \ganttmilestone[milestone/.append style={fill=orange!50}]{}{15} % HP??
  \ganttmilestone[milestone/.append style={fill=orange!50}]{}{20} % QM??
  \ganttmilestone[milestone/.append style={fill=orange!50}]{}{11} % seminar marathon for CNRS in January-February :p
  \ganttmilestone[milestone/.append style={fill=orange!50}]{}{23} % seminar marathon for CNRS in January-February :p
%  \ganttbar{Talks for graduate students}{19}{19}
\end{ganttchart}
\end{tikzpicture}
\end{center}
\vspace{-20pt}
\caption{Gantt chart. The \pbpb run is expected in November 2018.
% , its exact situation in the Gantt chart depends on the starting date of the project. 
The last line 
% (\emph{W, C, S}) 
stands for \emph{Workshops, conferences, seminars}.\label{fig:gantt}}
\end{figure}
...
\subsection{Appropriateness of the allocation of tasks and resources }\label{sec:appropriateness}
...
\begin{minipage}[ht]{0.63\textwidth}
Émilien Chapon\\
Laboratoire Leprince-Ringuet, École polytechnique\\
F91128 Palaiseau Cedex, France\\
\href{mailto:emilien.chapon@cern.ch}{emilien.chapon@cern.ch}
\end{minipage}
\hfill
\begin{minipage}[ht]{0.33\textwidth}
\href{http://orcid.org/0000-0001-6968-9828}{orcid.org/0000-0001-6968-9828}\\
French\\
January 3, 1987\\
+33 1 69 33 55 55
\end{minipage}
...
% \section*{Summary}
% Currently working on heavy ion collisions with the CMS experiment, at Laboratoire Leprince-Ringuet (École polytechnique, Palaiseau, France).
