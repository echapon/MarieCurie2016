...
researchers in the group will be a very important addition to the applicant
...
meeting will be held between the Supervisor and the applicant to monitor the
...
international training schools, the applicant will also have the chance take
...
% collisions and explored a completely new energy by analysing
% data with the ``SMOG'' fixed target setup.
She will not aonly oversee the ER, but also take active part in the development of the project.
\\\midrule
